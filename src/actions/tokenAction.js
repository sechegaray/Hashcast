...
export async function addToken ( tokenContractAddress ) {
  ...
  try {
    ...
    const tokenContract = new networkService.web3.eth.Contract(erc20abi, _tokenContractAddress);
    ...
    store.dispatch({
      ...
      payload: {currency: _tokenContractAddress, error: 'Not found'},
    });

    return {currency: _tokenContractAddress, error: 'Not found'};
  }
}